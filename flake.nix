{
  description = "Extensible elaborator project";
    ...
    (flake-utils.lib.eachDefaultSystem (
      ...
      in {
        packages = {
          ...
          paper = pkgs.callPackage ./paper/paper.nix {};
          slides = pkgs.callPackage ./paper/slides.nix {};
          abstract = pkgs.callPackage ./paper/abstract.nix {};
        };
        ...
        overlay = final: prev: {
          haskellPackages = prev.haskellPackages.override {
            ...
            in {
              eetc = callCabal2nixWithOptions "eetc" ./eetc "--no-check" {};
